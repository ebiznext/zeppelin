...
public class GitNotebookRepo extends VFSNotebookRepo implements NotebookRepoWithVersionControl {
    ...
    public void move(String noteId,
        ...
        try {
            git.commit().setCommitter(subject.getUser(), subject.getUser() + "@domain.ext").setMessage("Move note " + noteId + " from " + noteFileName + " to " +
...
<<<<<<< HEAD
    ...
    public void move(String folderPath, String newFolderPath,
        ...
        try {
            git.commit().setCommitter(subject.getUser(), subject.getUser() + "@domain.ext").setMessage("Move folder " + folderPath + " to " + newFolderPath).call();
        } catch (GitAPIException e) {
            throw new IOException(e);
        }
=======
    ...
    public List<Revision> revisionHistory(String noteId,
        ...
        try {
            ...
            for (RevCommit log : logs) {
                history.add(new Revision(log.getCommitterIdent().getName(), log.getName(), log.getShortMessage(), log.getCommitTime()));
